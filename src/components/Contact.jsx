...
const Contact = () => {
  ...
  return (
    <section ref={ref} id="contact" className="bg-[#0b0b0b] w-full min-h-screen relative overflow-hidden flex flex-col md:flex-row md:items-end pt-8 md:pt-32 pb-0 border-t border-white/10 select-none">
      ...
      {/* Huge Background Parallax Netflix Watermark Text (desktop only) */}
      <motion.div
        style={{ y }}
        className="hidden md:flex absolute top-0 left-0 w-full h-full flex-col justify-start items-center overflow-hidden pointer-events-none z-0 pt-16 md:pt-12 opacity-10"
      >
        <h1
      ...
      <div className="md:hidden w-full px-6 pb-8 relative z-10">
        <h2
      ...
      <div className="relative z-10 w-full flex justify-end items-end">
        <motion.div 
          ...
          className="bg-[#141414]/95 backdrop-blur-2xl border-t md:border-l border-white/15 w-full md:w-[90%] lg:w-[82%] p-6 sm:p-8 md:p-16 text-white flex flex-col justify-between rounded-t-3xl md:rounded-t-none md:rounded-tl-[3rem] shadow-[0_-25px_60px_rgba(0,0,0,0.9)] relative overflow-hidden"
        >
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-12 md:gap-16 w-full">
            ...
            <div className="flex flex-col md:flex-row gap-12 mt-4 pt-6 border-t border-white/10">
              ...
              <div className="flex-1 flex items-start gap-4 text-sm font-light text-white/70">
                ...
                />
                <label htmlFor="permission" className="cursor-pointer max-w-none md:max-w-[280px] leading-snug">
              ...
              <div className="flex-1 flex flex-col gap-8 text-xs text-white/50 font-light">
                <p className="leading-relaxed max-w-none md:max-w-[400px]">
                  This site is protected by security protocols and industry-standard privacy guidelines.
                </p>
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-6">
                  <p className="max-w-none md:max-w-[250px] leading-relaxed">

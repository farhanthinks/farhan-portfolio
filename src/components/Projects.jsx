...
const Projects = () => {
  ...
  return (
    <section id="projects" ref={containerRef} className="bg-[#0b0b0b] h-auto md:min-h-[170vh] relative font-sans overflow-x-clip text-white w-full flex flex-col md:flex-row items-center justify-center py-16 md:py-40 select-none">

      {/* Background Netflix Cinematic Title Watermark (desktop only) */}
      ...
      <div className="md:hidden w-full flex flex-col items-start justify-center text-left px-6 pb-2 relative z-10">
        <h2
      ...
      {/* Main Perspective Container (desktop folder + card reveal only) */}

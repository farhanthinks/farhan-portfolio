          ...
          <div className="lg:col-span-5 flex flex-col items-start space-y-5 lg:space-y-4 text-left">
            ...
            <div className="hero-anim-item flex flex-wrap items-center justify-center lg:justify-start gap-3 sm:gap-4 pt-1 w-full">
              <a
                ...
                aria-label="LinkedIn"
                className="w-11 h-11 md:w-9 md:h-9 flex items-center justify-center rounded-full border border-white/15 text-white/60 hover:text-red-500 hover:border-red-600/60 hover:shadow-[0_0_15px_rgba(229,9,20,0.5)] transition-all duration-300"
              >
                <svg className="w-[18px] h-[18px] md:w-4 md:h-4 fill-current" viewBox="0 0 24 24">

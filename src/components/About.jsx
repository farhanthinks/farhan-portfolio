        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          >
            ...
            <div className="space-y-5 relative z-10">
              <h3 className="text-xs font-mono uppercase tracking-widest text-red-500 font-bold">Profile & Background</h3>
              <p className="text-lg md:text-xl font-medium text-white/90 leading-relaxed">
                I am <span className="text-white font-bold drop-shadow">Mohammed Farhan</span>, a Full Stack Software Engineer focused on building responsive web applications and REST-based full-stack systems.
              </p>
              <p className="text-sm md:text-base text-white/60 font-light leading-relaxed">
                I work across frontend development, backend integration, databases, debugging, and deployment, turning ideas and UI concepts into functional, user-friendly applications.
              </p>
            </div>
            ...
            <div className="pt-8 flex flex-wrap gap-2 relative z-10">
              ...
              <span className="px-3.5 py-1.5 rounded bg-white/5 border border-white/10 text-xs font-mono text-white/80">Web Applications</span>
          ...
          >
            ...
            <div className="space-y-5 relative z-10">
              <h3 className="text-xs font-mono uppercase tracking-widest text-red-500 font-bold">Experience</h3>
              <div className="space-y-1">
                <p className="text-sm font-bold text-white">Software Engineer / Full Stack Developer</p>
                <p className="text-sm text-white/70">IN10C5 India Private Limited</p>
                <p className="text-xs font-mono text-white/40 tracking-wider">SEP 2024 — PRESENT</p>
              </div>
              <div>
                <p className="text-sm text-white/80 font-light leading-relaxed">
                  Experienced in building responsive web applications, integrating APIs, working with databases, and developing reliable full-stack solutions. Comfortable working across frontend and backend development while solving problems and delivering clean, user-focused applications.
                </p>
                <p className="text-sm text-white/80 font-light leading-relaxed">
                  <strong className="text-white font-semibold">Experienced in turning ideas into functional digital products with a focus on performance and usability.</strong>{' '}
                  <strong className="text-white font-semibold">Passionate about learning new technologies and building scalable solutions.</strong>
                </p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="space-y-2 text-left relative z-10">
              ...
              <p className="text-base md:text-lg font-semibold text-white">Modern tools and technologies for building scalable web applications.</p>
            </div>

            <div className="flex flex-wrap items-center gap-3 relative z-10">
              {['Next.js', 'JavaScript', 'Python', 'PostgreSQL', 'Docker', 'Cloud'].map((tech, idx) => (
                <span
                  key={idx}
